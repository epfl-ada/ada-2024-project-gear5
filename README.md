...
│   │   ├── Impact.py                       <- Used to run Impact 
│   │   ├── sentiment_analysis.py           <- Used to run sentiment analysis 
│   ├── utils                           <- Utility directory
│   │   │
│   │   ├── print_prediction.py              <- Printing prediction proof of concept
│   │   ├── results_utils.py                 <- Printing prediction proof of concept
│
├── .gitignore                  <- List of files ignored by git
├── requirements.txt            <- File for installing python dependencies
├── methods.ipynb               <- presents methods used for analysis
├── plots.ipynb                 <- a well-structured notebook for generating plots for the data story
...
├── sentiment_analysis.ipynb    <- a well-structured notebook for performing sentiment analysis
└── README.md
